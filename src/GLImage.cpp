...
void GLImage::Initialize(const int xSize, const int ySize, SDL_Renderer* pRenderer)
{
...
void GLImage::setPixel(const int x, const int y, const double red, const double green, const double blue)
{
...
Uint32 GLImage::ConvertColor(const double red, const double green, const double blue)
{
